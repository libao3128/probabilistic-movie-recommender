...
class BaseRecommenderReporter:
    ...
    Usage:
        reporter = BaseRecommenderReporter(results)
        reporter.plot_all()
    ...
    def __init__(self, results):
        """
        Args:
            results (dict): Contains 'actuals', 'predictions', and metrics.
        """
...
class HBMRecommenderReporter(BaseRecommenderReporter):
    ...
    Usage:
        ...
        reporter.print_stats()
    """
    def __init__(self, model, movies, results):
    ...
    def plot_all(self, save_path='hbm_results.png'):
        ...
        ax.legend()
        plt.tight_layout()
        plt.savefig('hbm_param_results.png')
        plt.close()
    ...
    def print_stats(self):
        ...
        movie_bias = movie_bias.merge(self.movies[['movieId', 'title']], on='movieId')
